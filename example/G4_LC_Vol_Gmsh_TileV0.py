...
G4input = G4Inp(CurrentFolder="/storage/af/user/greales/simG4/BTL_LYSOARRAY_LO_G4/", OutFolder =  "/storage/af/user/greales/simG4/outputs/", SubName="SubDefaultName", OutName="Out_NSGA", JobName="JobActionNSGATestGmsh.sh", SiPMS=False, LYSOL=True, ROOTName='Generation_', RelativeFolder="../../../Results/", Singularity = '+SingularityImage="/storage/af/user/greales/SingDir/sandG4Gmsh"',SZloc=True)
...
var_range=[(8,28.5),(0.1,0.9),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5),(0.1,5)]
...
evo = Evolution(problem,G4InputClass=G4input, mutation_param=20, num_of_generations=100, num_of_individuals=100, TierII=1,init_evo='',Generation_evo=0 )
